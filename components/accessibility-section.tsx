        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr,auto,1fr] gap-6 md:gap-4 items-center">
          ...
          >
            <div>
              ...
              <Image
                src="https://raw.githubusercontent.com/DannyYo696/svillage/main/accessibility.png?raw=true"
          ...
          >
            ...
            <p className="font-pixel text-white text-xs md:text-sm leading-relaxed">
              Q3 marks a major leap in accessibility as Mutant Rolls becomes fully playable on mobile through a
              seamless, app-like Progressive Web App (PWA). This mobile rollout allows players to stake, scavenge,
              battle, and upgrade on the go—anytime, anywhere, without App Store restrictions or downloads. To amplify
              this milestone, a high-impact marketing campaign on Cointelegraph will spotlight Mutant Rolls as one of
              Web3's most user-ready games, drawing attention from global audiences and mobile-first players alike.
            </p>
          </div>
        </div>
      </div>
