        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr,auto,1fr] gap-6 md:gap-4 items-center">
          ...
          >
            <div>
              ...
              <Image
                src="https://raw.githubusercontent.com/DannyYo696/svillage/main/eco1.png?raw=true"
          ...
          <div ref={timelineRef} className="flex flex-col items-center justify-center h-full relative py-8">
            ...
            >
              ...
              <div className="font-pixel text-yellow-300 text-xl font-bold">Q4</div>
            </div>
          ...
          >
            ...
            <p className="font-pixel text-white text-xs md:text-sm leading-relaxed">
              The Staking & Dividend Pool System goes live, allowing players to lock MUTR tokens and earn passive
              rewards backed by the Combined Liquidity Reserve (CLR). This quarter also sees the launch of the
              long-awaited Mutant Clash mode—an intense, wave-based survival game where strategy, gear, and risk
              collide. Meanwhile, targeted marketing efforts begin, including a featured campaign on Cointraffic,
              expanding visibility and drawing in the next wave of players and early backers.
            </p>
          </div>
        </div>
      </div>
