        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr,auto,1fr] gap-6 md:gap-4 items-center">
          ...
          >
            <div>
              ...
              <Image
                src="https://raw.githubusercontent.com/DannyYo696/svillage/main/growth.png?raw=true"
          ...
          >
            ...
            <p className="font-pixel text-white text-xs md:text-sm leading-relaxed">
              Q4 focuses on reinforcing long-term ecosystem health with a second $25,000 MUTR buyback, signaling
              stability and trust to both players and investors. A new wave of targeted ad campaigns via Blockchain-Ads
              will expand Mutant Rolls' global footprint—aimed at onboarding fresh players and amplifying the game's
              position as a top-tier title in the Web3 space.
            </p>
          </div>
        </div>
      </div>
