        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr,auto,1fr] gap-6 md:gap-4 items-center">
          ...
          >
            <div>
              ...
              <Image
                src="https://raw.githubusercontent.com/DannyYo696/svillage/main/innovation.png?raw=true"
          ...
          <div ref={timelineRef} className="flex flex-col items-center justify-center h-full relative py-8">
            ...
            >
              ...
              <div className="font-pixel text-yellow-300 text-xl font-bold">Q2</div>
            </div>
          ...
          >
            ...
            <p className="font-pixel text-white text-xs md:text-sm leading-relaxed">
              Q2 brings a fresh wave of innovation, starting with the launch of Zombie Luck—a strategic mini-game that
              fuses slot machine tension with player-driven risk and reward mechanics. A global Leaderboard System will
              also debut, tracking player performance across modes and unlocking future rewards, rankings, and bragging
              rights for top survivors. To support this growth, a new marketing campaign via Bitmedia will drive traffic
              and expand the community, positioning Mutant Rolls for viral traction and Web3 visibility.
            </p>
          </div>
        </div>
      </div>
